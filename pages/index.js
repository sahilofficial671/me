  ...
  const projects = [
    {
      ...
      github: "https://github.com/sahilofficial671/blogpost-backend",
  ...
  return (
    <>
      ...
      <p className="text-lg tracking-wide pb-4 md:pb-12">
        ...
        <div className="pt-6">
          <a href="https://drive.google.com/file/d/1N2FykbdGlOFvmT7n1PTKQrv2QjkS5hzr/view?usp=sharing" target="_blank">
